    ...
    <form @submit="onSubmit" class="mb-4 flex flex-col h-[calc(100%-140px)]">
      <div class="mb-2">
        ...
        <InputText
          ...
          v-model="name"
          type="text"
          class="rounded-2xl w-full p-5 border border-none"
      ...
      <div class="mb-2">
        ...
        <InputText
          ...
          v-model="phone"
          type="tel"
          class="rounded-2xl w-full p-5 border-none"
          style="background: rgba(0, 0, 0, 0.05)"
          autocomplete="off"
          placeholder="contoh: 6285xxxxxxxx or 085xxxxxxxx"
        />
      ...
      <div class="mb-2">
        ...
        <Textarea
          ...
          v-model="address"
          type="text"
          class="rounded-2xl w-full p-5 border border-none min-h-28"
          style="background: rgba(0, 0, 0, 0.05)"
          autocomplete="off"
        />
      </div>
      <button type="submit" class="text-base font-medium p-5 w-full mt-auto text-white bg-blue rounded">
